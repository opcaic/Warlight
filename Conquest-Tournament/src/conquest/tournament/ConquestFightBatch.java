...
public class ConquestFightBatch {
	...
	public void fight(String botId1, String botId2, boolean reverseGames, File tableFile, File resultDirFile, File replayDirFile, File resultJsonFile) {
		...
		ConquestFight fight = new ConquestFight(fightConfig, tableFile, resultDirFile, replayDirFile, resultJsonFile);
	...
	public void fight(String botId, boolean reverseGames, File tableFile, File resultDirFile, File replayDirFile, File resultJsonFile) {
			...
			for (Object key1 : keys)
				for (Object key2 : keys) {
					...
					if (botId1.compareTo(botId2) < 0)
						fight(botId1, botId2, reverseGames, tableFile, resultDirFile, replayDirFile, resultJsonFile);
				}
			return;
		}
		...
		for (Object key : keys) {
			...
			if (!botId.equals(otherBotId))
				fight(botId, otherBotId, reverseGames, tableFile, resultDirFile, replayDirFile, resultJsonFile);
		}
